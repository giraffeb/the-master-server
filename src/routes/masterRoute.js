...
masterRouter.post('/register', async (req, res, next) => {
  const {
    name,
    gender,
    email,
...
// @desc      Login Master
masterRouter.post('/login', async (req, res, next) => {
...
// @desc      Get a Master
masterRouter.get('/:masterId', async (req, res, next) => {
...
masterRouter.delete('/:masterId', protectmaster, async (req, res, next) => {
  const { masterId } = req.params;
...
// @desc      Put a Master
masterRouter.put('/:masterId', protectmaster, async (req, res, next) => {
  const { masterId } = req.params;
